...
class FeedComment extends StatefulWidget {
  final String feedId;
  final String userId;
  const FeedComment({Key key, @required this.feedId, @required this.userId})
      : super(key: key);
                  ...
                  children: <Widget>[
                    ...
                    Row(
                      children: <Widget>[
                        TextButton(
                          child: Text(
                              '${snapshot.data["comment"][i]["updateAt"]}'),
                          onPressed: null,
                        ...
                        //),
                        if (userId ==
                            '${snapshot.data["comment"][i]["userId"]}')
                          TextButton(
                            child: Text("삭제"),
                            onPressed: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => CommentDelete(
                                          userId: userId,
                                          feedCommentId:
                                              '${snapshot.data["comment"][i]["feedCommentId"]}',
                                          feedId: feedId)));
                            },
                            style: TextButton.styleFrom(
                              fixedSize: Size.fromHeight(1),
