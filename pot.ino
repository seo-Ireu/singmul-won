...
const String rx_url = "/ubuntu/arduino/input_data.php?myPlantId=1";  
...
Serial.println(water);
 if ( water > 0)   // 토양 습도 체크 적정습도 보다 낮으면 모터 동작 시켜 물공급 아니면 정지, (1023 - humidity.toInt()*1023/100)
   {
